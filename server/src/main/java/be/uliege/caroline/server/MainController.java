...
import be.uliege.caroline.server.UserRepository;
...
public class MainController {
  ...
  public Patient addNewPatient (@RequestBody Patient u) {
  ...
  public Users addNewUser (@RequestBody Users u) {
    // @ResponseBody means the returned String is the response, not a view name
    // @RequestParam means it is a parameter from the GET or POST request
	log.info("Add user request " + u.getIdentifier());
	log.info("Blabla " + userRepository.count());   
